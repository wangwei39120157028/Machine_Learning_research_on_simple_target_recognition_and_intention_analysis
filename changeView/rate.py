...
def AngleSet(lgS):
    ...
    for c in lgS:
        if c[0] <= (math.pi / 12):
            ...
            S60+= c[1]
        elif c[0] <= 5 * math.pi / 12:
            S75+= c[1]
        elif c[0] <= math.pi / 2:
            S90+= c[1]
        elif c[0] <= 7 * math.pi / 12:
            S105+= c[1]
        elif c[0] <= 2 * math.pi / 3:
            S120+= c[1]
        elif c[0] <= 9 * math.pi / 12:
            S135+= c[1]
        elif c[0] <= 10 * math.pi / 12:
            S150+= c[1]
        elif c[0] <= 11 * math.pi / 12:
            S165+= c[1]
        elif c[0] <= 12 * math.pi / 12:
            S180+= c[1]
        elif c[0] <= 13 * math.pi / 12:
            S195+= c[1]
        elif c[0] <= 14 * math.pi / 12:
            S210+= c[1]
        elif c[0] <= 15 * math.pi / 12:
            S225+= c[1]
        elif c[0] <= 16 * math.pi / 12:
            S240+= c[1]
        elif c[0] <= 17 * math.pi / 12:
            S255+= c[1]
        elif c[0] <= 18 * math.pi / 12:
            S270+= c[1]
        elif c[0] <= 19 * math.pi / 12:
            S285+= c[1]
        elif c <= 20 * math.pi / 12:
            S300+= c[1]
        elif c[0] <= 21 * math.pi / 12:
            S315+= c[1]
        elif c[0] <= 22 * math.pi / 12:
            S330+= c[1]
        elif c[0] <= 23 * math.pi / 12:
            S345+= c[1]
        elif c[0] <= 24 * math.pi / 12:
            S360+= c[1]
        else:
            print("wrong0000")
